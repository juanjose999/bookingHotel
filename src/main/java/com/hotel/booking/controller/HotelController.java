...
public class HotelController {
    ...
    public ResponseEntity<HotelResponseDto> findHotelById(@PathVariable String idHotel){
        try{
            ...
            return new ResponseEntity("the hotel + " +  idHotel + " does't in the data base.", HttpStatus.NOT_FOUND);
        }
    }
    ...
    public ResponseEntity<Boolean> deleteBooking(@PathVariable String idHotel){
